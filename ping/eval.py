...
if __name__ == '__main__':
	...
	extractor.load_state_dict(torch.load('./model/2infograph/extractor_9.pth'))
	for source in source_domain:
		...
		source_clf[source]['c1'].load_state_dict(torch.load('./model/2infograph/'+source+'_c1_9.pth'))
		source_clf[source]['c2'].load_state_dict(torch.load('./model/2infograph/'+source+'_c2_9.pth'))
